...
class UploadFile {//类定义开始
    ...
    private $config =   array(
        ...
        'uploadRecord'=>false,// 记录数据库
        'saveRule'=>'',// 上传文件命名规则,如果为avatar，则为配置文件里的THINK_UPLOAD.avatar文件命名规则
    ...
    private function getSaveName($filename) {
        ...
        if(empty($rule)) {//没有定义命名规则，则保持文件名不变
        	...
        	//如果规则名为avatar，则为上传头像规则
        	if($rule == 'avatar'){
        		$config = C('THINK_UPLOAD.avatar');
        		$saveName = 'temp.jpg';
        	}else{
    ...
    private function getSubName($file) {
        ...
        if(!$this->isFtp && !is_dir($file['savepath'].$dir)) {

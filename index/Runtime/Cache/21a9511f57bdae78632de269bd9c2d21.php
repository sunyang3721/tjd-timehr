<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns:wb="http://open.weibo.com/wb"><head><meta http-equiv="content-type" content="text/html; charset=UTF-8"/><meta name="baidu-site-verification" content="YSJ9mJB7HA" /><Meta name="Keywords" Content="腾驹达,猎头顾问,景素奇,万达,合作,招聘"><Meta name="Description" Content="腾驹达猎头公司由知名人力资源专家景素奇先生于2003年创办，自成立之始，一改传统的猎头销售服务模式，走出了一条与众不同的成长发展之路。"><Meta name="Robots" Content="All"><title><?php echo (C("Benefit_jz.2")); ?></title><link rel="stylesheet" href="__PUBLIC__/css/body.css" type="text/css" media="screen" /><link rel="stylesheet" href="__PUBLIC__/css/header.css" type="text/css" media="screen" /><link rel="stylesheet" href="__PUBLIC__/css/footer.css" type="text/css" media="screen" /><script src="__PUBLIC__/js/jquery-1.8.3.min.js"></script><!--弹窗提示--><link rel="stylesheet" href="__PUBLIC__/css/reveal.css"><script type="text/javascript" src="__PUBLIC__/js/jquery.reveal.js"></script><!--弹窗提示 end--><body><div id="nav-h26" class="w960 margin"><span>腾驹达网站群： 
...
</script><link rel="stylesheet" href="__PUBLIC__/css/enter/enter_ys.css" type="text/css" media="screen" /><script type="text/javascript" src="__PUBLIC__/js/smohan.fixednav.js"></script><script type="text/javascript">$(document).ready(function(e) {
 $('#mynav').smohanfixednav(-6,999);    
});
</script><div class="w960 margin"><div class="title"><span class="size28">公益活动</span><span class="lianjie">首页 > 公益活动 ><?php echo (C("Benefit_jz.2")); ?></span></div></div><div class="w960 margin bg-left"><div class="left-nav align-left" id="mynav"><ul><li><a href="<?php echo (C("Benefit.1")); ?>"><?php echo (C("Benefit.2")); ?></a></li><!-- <li><a href="<?php echo (C("Benefit_zz.1")); ?>"><?php echo (C("Benefit_zz.2")); ?></a></li> --><li class="btn"><a href="<?php echo (C("Benefit_jz.1")); ?>"><?php echo (C("Benefit_jz.2")); ?></a></li><li><a href="<?php echo (C("Benefit_zs.1")); ?>"><?php echo (C("Benefit_zs.2")); ?></a></li><li><a href="<?php echo (C("Benefit_yw.1")); ?>"><?php echo (C("Benefit_yw.2")); ?></a></li></ul></div><div class="right-nav align-right"><h1><?php echo (C("Benefit_jz.2")); ?></h1><div class="con"><div class="warp"><?php echo ($list["content"]); ?></div></div></div><div class="clear"></div></div><div id="footer"><div>人才招聘 Email:liangyanqin@timehr.com 个人求职 Email:hrm@timehr.com 或垂询:010-82659228/29<br/>		京ICP备13013083号 京公网安备11010802015690号 猎头资质号：RC0501191 <br/>		©2013 国际人力资本网版权所有
		</div></div></body></html>
...
$(document).ready(function(e) {
 ...
 <div class="w960 margin">
		<div class="title"><span class="size28">加入我们</span><span class="lianjie">首页 > 加入我们 > <?php echo (C("Join.2")); ?></span></div>
</div> 
 <div class="w960 margin bg-left">
		<div class="left-nav align-left" id="mynav">
				<ul>
						<li class="btn"><a href="<?php echo (C("Join.1")); ?>"><?php echo (C("Join.2")); ?></a></li>
						<li><a href="<?php echo (C("Join_qt.1")); ?>"><?php echo (C("Join_qt.2")); ?></a></li>

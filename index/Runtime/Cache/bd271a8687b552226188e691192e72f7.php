...
$(document).ready(function(e) {
 ...
 <div class="w960 margin bg-left">
		<div class="left-nav align-left" id="mynav">
				<ul>
						<li class="btn"><a href="<?php echo U('Timehr/index');?>">Individual Resume</a></li>
						<li ><a href="<?php echo U('Timehr/company');?>">company introduction</a></li>
		...
		<div class="right-nav align-right">
				<h1>TimeHR Executive Search</h1>
				<div class="con">
						<div class="warp">
								<p><b>Secretary-general unit of Executive Search Professional Committee of China Human Resource Association——The ONLY official association of executive search in China</b></p>
								<p><b>The TimeHR Executive Search Co, Ltd was founded by Mr. Jing Suqi, who is known as one of the best experts in human resources field, in 2003. The corporation has explored a new path which unique to other peers ever since it stepped into this industry.</b></p>
								...
								<p><b>Honor Gallery</b><BR><img src="__PUBLIC__/images/en_1.png" alt="" width="" height="" style="margin-left:30px;"/></p>
								<p><b>Social Activities</b></p>
								<p><img src="__PUBLIC__/images/en_2.png" alt="" width="" height="" style="margin-left:30px;"/><BR><b>Mr. Jing Suqi represented the Alumni of Harvard in Beijing and drafted the lottery in banquet.</b></p>
								<p><img src="__PUBLIC__/images/en_3.png" alt="" width="" height="" style="margin-left:30px;"/><BR><b>Mr. Jing Suqi represented the Alumni of Wharton School in Beijing.</b></p>
								<p><img src="__PUBLIC__/images/en_4.png" alt="" width="" height="" style="margin-left:30px;"/><BR><b>Mr. Jing Suqi represented the Award Ceremony of Jing Suqi Scholarship in the Central University of Finance and Economics.</b></p>
								<p><img src="__PUBLIC__/images/en_5.png" alt="" width="" height="" style="margin-left:30px;"/><BR><b>Mr. Jing Suqi represented the Award Ceremony of Jing Suqi Scholarship in Beijing Institute of Graphic Communication.</b></p>
								<p><img src="__PUBLIC__/images/en_6.png" alt="" width="" height="" style="margin-left:30px;"/><BR><b>Introduction of Mr. Jing Suqi</b><BR><img src="__PUBLIC__/images/en_7.png" alt="" width="" height="" style="margin-left:30px;"/></p>
								<p> Mr. Jing Suqi<br/>
										Chairman of TimeHR consulting & management Co, Ltd<br/>
										President of TimeHR.com<br/>
										Secretary-general of Executive Search Professional Committee of China Human Resource Association<br/>
										 Commissioner of National Standardization Committee of Career Manager<br/>
										Advisor and commentator of “The Ultimate Challenge”, a TV reality in CCTV<br/>
										Advisor and jury of “Best employer of the year”, a TV reward in CCTV<br/>
										Visiting professor at Peking University<br/>
										Visiting professor at School of Humanities &Economic Management of China University of Geosciences<br/>
										Part-time professor at Central University of Finance & Economics<br/>
										Visiting professor at Beijing Institute of Technology<br/>
										Head of Qizheng Management Club<br/>
										Independent director<br/>
										Columnist at “Sino-Foreign Management” magazine<br/>

										The TimeHR was founded by Jing in 2003. The corporation is now recognized among the top executive search corporations. In 2014, TimeHR was awarded the secretary-general unit of of Executive Search Professional Committee of China Human Resource Association, which is an unique honor in peers. <br/>

										For over a decade, Jing concentrates on research and practice in the field of human resources. Many of his articles which focused in career development and human resource management were published. Jing was invited as a columnist in “Sino-Foreign Management” magazine since 2000 and still share his ideas through this platform. In 2007, Jing gathered his thoughts and forged them into the book “Baton of the Manager”. This book is unexpected popular among career managers and entrepreneurs. The book was reprinted in 2011 and selected as a reference book by Guanghua School of Management, Peking University. <br/>

										Jing, also known as the head of Qizheng Management Club, founded this non-profit organization with “Sino-Foreign Management” magazine and School of Humanities &Economic Management of China University of Geosciences in June, 2004. The club has held over 430 saloons in Beijing, and also has branches in Shanghai and Shenzhen. Jing also launched over 600 other public activities which mainly intended to provide career consulting and profession guidance. <br/>
								</p>
						</div>
				</div>
		</div>

 ...
 $('#main-nav').smohanfixednav(10,999);    
  ...
  <div id="main-content">
    ...
    <ul class="shortcut-buttons-set">
      <li><a class="shortcut-button" href="__APP__/Job/add"><span><img src="__PUBLIC__/admin/images/icons/paper_content_pencil_48.png"><br/>新增</span></a></li>
	  <li><a class="shortcut-button" href="__APP__/Job/delhome"><span><img src="__PUBLIC__/admin/images/icons/10.png"><br/>回收站</span></a></li>
    </ul>
...
<div class="content-box-content">
      ...
      <div>
				<form method="post" action="__APP__/Job">
					<div id="soso">
                    <select name="classif">
                      <option value="0">&nbsp;全&nbsp;部</option>
					  <option value="1">职位编号</option>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr delnum="<?php echo ($vo["id"]); ?>">
                ...
                <td><a href="__ROOT__/Person/job_show/<?php echo ($vo["id"]); ?>"  target="_blank" class="overtext"><?php echo ($vo["jobname"]); ?></a></td>
                <td>
				<?php switch($vo['industry']): case "1": ?>金融业<?php break;?>
						<?php case "2": ?>房地产<?php break;?>
						<?php case "3": ?>商业连锁<?php break;?>
						<?php case "4": ?>IT/互联网/电子商务<?php break;?>
						<?php case "5": ?>制药/医疗<?php break;?>
						<?php case "6": ?>文化产业<?php break;?>
						<?php case "7": ?>广告/媒体<?php break;?>
						<?php case "8": ?>加工制造/仪表设备<?php break;?>
						<?php case "9": ?>交通/物流/运输<?php break;?>
						<?php case "10": ?>教育/培训<?php break;?>
						<?php case "11": ?>旅游/酒店/餐饮/休闲<?php break;?>
						<?php case "12": ?>能源/采掘/化工/环保<?php break;?>
						<?php case "13": ?>政府/农林牧渔/其他<?php break;?>
						<?php case "14": ?>消费品/贸易/批发/零售<?php break;?>
					<?php default: ?>其他行业<?php endswitch;?>
				</td>
                ...
                <td>
                  <a href="__APP__/Job/edit/<?php echo ($vo["id"]); ?>" title="编辑职位"><img src="__PUBLIC__/admin/images/icons/pencil.png" alt="Edit" /></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" class="del" delnum="<?php echo ($vo["id"]); ?>"><img src="__PUBLIC__/admin/images/icons/cross.png" alt="Delete" /></a> </td>

...
<div class="content-box-content">
      ...
      <div>
				<form method="post" action="<?php echo U('Kehu/index');?>">
					<div id="soso"><b style="font-size:16px;">客户名称</b>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                ...
                <td><a href="<?php echo U('Kehu/show',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></td>
                <td><?php echo (date('Y-m-d',$vo["date"])); ?></td>
				<td>
					<?php switch($vo["status"]): case "1": ?><span style="color:#33cc00;">正在进行中</span><?php break;?>
						<?php case "2": ?><span style="color:#808080;">任务已关闭</span><?php break; endswitch;?>
				</td>
                <td>
					<span style="color:#33cc00;"><!-- <a href="<?php echo U('Kehu/img',array('id'=>$vo['id']));?>">修改图片</a> |  --><a href="<?php echo U('Kehu/modify',array('id'=>$vo['id']));?>" title="编辑客户信息"><img src="__PUBLIC__/admin/images/icons/pencil.png" alt="Edit" />修改</a> | <a href="<?php echo U('Kehu/del',array('id'=>$vo['id']));?>" onclick="return confirm('确定要删除?')"><img src="__PUBLIC__/admin/images/icons/cross.png">删除</a></span>
				</td>

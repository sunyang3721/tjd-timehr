...
/*
	$(document).ready(function(){
		$('select[name=classif]').change(function(){
...
<div class="content-box-content">
		<form method="post" action="__URL__/adding">
		 <div class="tab-content default-tab" style="width:720px;margin:0 auto;">
				<span style="margin-bottom:5px;display:block;"><b>员工编号：</b><input type="text" size="40" name="username" style="font-family:'微软雅黑';">例如：128 （不可更改）</span><br>
				<span style="margin-bottom:5px;display:block;"><b>员工姓名：</b><input type="text" size="40" name="yourname" style="font-family:'微软雅黑';">例如：张三（不可更改）</span><br>
				<span style="margin-bottom:5px;display:block;"><b>输入密码：</b><input type="password" size="40" name="password" style="font-family:'微软雅黑';"></span><br>
				<span style="margin-bottom:5px;display:block;"><b>再输密码：</b><input type="password" size="40" name="passwords" style="font-family:'微软雅黑';"></span><br>
				</div>
		<div class="tab-content default-tab" style="width:720px;margin:0 auto;">
				<span style="margin-bottom:10px;display:block;"><b>登录状态：</b>
								<select name="status">
									<option value="1">开启（在职）
									<option value="2">禁用（离职）
								</select><br><br>
        </div>
		<div class="tab-content default-tab" style="width:720px;margin:0 auto;">
				<span style="margin-bottom:10px;display:block;"><b>所属用户分组：</b>
								<select name="role_id">
				...
				<input type="submit" value="确定添加" style="font-size:18px;">
        </div>
		</form>
      </div>

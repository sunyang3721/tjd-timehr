...
<div class="content-box-content">
		<form method="post" action="__URL__/save">
		 ...
		 <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
				<span style="margin-bottom:5px;display:block;"><b>员工编号：</b><?php echo ($list["username"]); ?></span><br>
				<span style="margin-bottom:5px;display:block;"><b>员工姓名：</b><?php echo ($list["yourname"]); ?></span><br>
				<span style="margin-bottom:5px;display:block;"><b>&nbsp;&nbsp;&nbsp;新密码：</b><input type="password" size="40" name="password" style="font-family:'微软雅黑';"></span><br>

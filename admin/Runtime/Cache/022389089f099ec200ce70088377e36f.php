...
<div class="content-box-content">
		...
		<form method="post" action="<?php echo U('Rbac/addNodeHandle');?>">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			 ...
			 <tr>
                <td>状态：</td>
				<td class="right"><INPUT type="radio" name="status" value="1" checked>启用 <INPUT type="radio" name="status" value="0">禁用</td>
			 </tr>
			 <tr>
                <td >类型：</td>
				<td class="right">
							<SELECT name="level">
								<OPTION value="1" selected>项目
								<OPTION value="2">模块
								<OPTION value="3">操作
							</SELECT>
				</td>
			 ...
			 <tr>
                <td >排序：</td>
				<td class="right"><INPUT type="text" name="sort"></td>
			 </tr>
			 <tr>
                <td>&nbsp;</td>
				<td class="right"><INPUT type="submit" value="提交添加" style="padding:5px 20px;"></td>
			 </tr>
            </tbody>
          </table>
		</form>

  ...
  <div id="main-content">
    <!-- Page Head -->
     <ul class="shortcut-buttons-set">
	   <li><a class="shortcut-button" href="<?php echo U('Kehu/add');?>"><span><img src="__PUBLIC__/admin/images/icons/19.png"><br/>新增客户</span></a></li>
	   <li><a class="shortcut-button" href="<?php echo U('Kehu/index');?>"><span><img src="__PUBLIC__/admin/images/icons/8.png"><br/>查看客户资料</span></a></li>
	   <li><a class="shortcut-button" href="<?php echo U('Kehu/job');?>"><span><img src="__PUBLIC__/admin/images/icons/18.png"><br/>查看职位信息</span></a></li>
    </ul>
...
<div class="content-box-content">
      ...
      <div>
				<form method="post" action="<?php echo U('Kehu/job');?>">
					<div id="soso"><b style="font-size:16px;">职位名称</b>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<td><a href="__URL__/showjob/<?php echo ($vo["sid"]); ?>"  target="_blank"><?php echo ($vo["jobname"]); ?></a></td>
                <td><?php echo (date('Y-m-d',$vo["newdate"])); ?></td>
				<td><?php echo ($vo["yourname"]); ?></td>
				<td>
					<?php switch($vo["status"]): case "1": ?><span style="color:#33cc00;">正在进行中</span><?php break;?>
						<?php case "2": ?><span style="color:#66ffff;">即将开始</span><?php break;?>
						<?php case "3": ?><span style="color:#808080;">已关闭或结束</span><?php break; endswitch;?>
				</td>
                <td>
					<span style="color:#33cc00;"><a href="<?php echo U('Kehu/updata',array('id'=>$vo['sid']));?>" title="编辑客户信息"><img src="__PUBLIC__/admin/images/icons/pencil.png" alt="Edit" />修改</a> |  <a href="<?php echo U('Kehu/dele',array('id'=>$vo['sid']));?>" onclick="return confirm('确定要删除?')"><img src="__PUBLIC__/admin/images/icons/cross.png">删除</a></span>
				</td>

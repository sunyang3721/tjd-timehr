...
<div class="content-box-content">
		...
		<form method="post" action="<?php echo U('Rbac/addRoleHandle');?>">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			 ...
			 <tr>
                <td>角色描述：</td>
				<td class="right"><INPUT type="text" name="remark"></td>
			 </tr>
			 <tr>
                <td>是否开启：</td>
				<td class="right"><INPUT type="radio" name="status" value="1" checked>开启 <INPUT type="radio" name="status" value="0">关闭</td>
			 </tr>
			 <tr>
                <td>&nbsp;</td>

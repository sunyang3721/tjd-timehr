      ...
      <div>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<td>
					<span style="color:#33cc00;"><a href="<?php echo U('Lsku/uphui',array('id'=>$vo['id']));?>" title="恢复" onclick="return confirm('确定要恢复？请记住编号！')"><img src="__PUBLIC__/admin/images/icons/pencil.png" />恢复</a></span>
				</td>

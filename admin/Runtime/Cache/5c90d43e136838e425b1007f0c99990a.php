        ...
        <div class="tab-content default-tab">
          <table>
			...
			<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo (($vo["remark"])?($vo["remark"]):"<i style='color:#888;'>未填写</i>"); ?></td>
				<td><?php if($vo["status"] == 1 ): ?><span style="color:blue;">开启<?php else: ?> <span style="color:#888">关闭<?php endif; ?></td>
				<td><a href="<?php echo U('Rbac/access',array('rid'=>$vo['id']));?>">配置权限</a> | <a href="<?php echo U('Rbac/editRole',array('rid'=>$vo['id']));?>">修改角色</a></td>
